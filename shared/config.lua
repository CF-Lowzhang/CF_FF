...
F4_Config.Trigger = function(type,message,keynumber)
   if type == 'event' then
   ...
   elseif type == 'emotes' then
      ...
      --print('haha') 
      ExecuteCommand('CF_FF:keybind:Menu '..keynumber)
   end
end

F4_Config.xMenu = {
   PlayerMenu = {
      key1 = {type="未設定", value="未設定",label="未設定"}, --The first field is your Event or Command name, the second field is the type "command" OR "event"
      key2 = {type="未設定", value="未設定",label="未設定"},
      key3 = {type="未設定", value="未設定",label="未設定"},
      key4 = {type="未設定", value="未設定",label="未設定"},
      key5 = {type="未設定", value="未設定",label="未設定"},
      key6 = {type="未設定", value="未設定",label="未設定"},
      key7 = {type="未設定", value="未設定",label="未設定"},
      key8 = {type="未設定", value="未設定",label="未設定"},
      key9 = {type="未設定", value="未設定",label="未設定"},
      key10 = {type="未設定", value="未設定",label="未設定"},
      key11 = {type="未設定", value="未設定",label="未設定"},
      key12 = {type="未設定", value="未設定",label="未設定"},
      key13 = {type="command", value="CF_FF:keybind:Menu",label="設定選單"},
   },
   OnVehicleMenu = {
